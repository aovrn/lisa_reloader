...
Правила написания файла конфишурации:
 ...
 2.4. Секция [name]
 2.4.1 Имя аргумента регистронезависимо
...
-------------------------------------------------------------------------------
 section			Имя секции
	...
	argument4 = 0	Аргумент со значением по умолчанию 0
...
-------------------------------------------------------------------------------
 FindWnd			Искать окно или окна wnd.
	...
	onError			Если onError указан и FindWindow не нашел хотя бы одно окно
					или не пройдена проверка chech переходим к указанной
					секции.
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
 msg				Любое системное сообщение Windows или пользовательское.
...
-------------------------------------------------------------------------------
 path				Строка с двумя значениями, первое -- это путь до
					исполнаемого файла, второе -- это параметры запуска.
